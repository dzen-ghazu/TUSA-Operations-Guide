---
title: (Home) User Management
---
# User Management

Welcome to the User Management section.

This section contains guides for managing users, club stores, user grids, profiles, and annual student confirmations.

## Guides

- [Connecting Users to a Club Store](club-store.md)
